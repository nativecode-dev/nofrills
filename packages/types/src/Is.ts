...
export const Is: IsType = {
  ...
  arrayOf: (value: any[], type: string = 'any'): boolean => Is.array(value) && value
    .map((element: any) => Is[type](element, type))
  ...
  object: (value: any, type?: string): boolean => typeof value === 'object' && Is.array(value) === false && Is.date(value) === false,
