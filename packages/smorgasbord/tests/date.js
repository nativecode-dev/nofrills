...
describe('when using Dates helping', () => {
  it('should return today\'s date', () => {
    ...
    const today = smorgasbord.Dates.today(expected)
  ...
  it('should return yesterday\'s date', () => {
    ...
    const expected = new Date(2017, 6, 30)
    const yesterday = smorgasbord.Dates.yesterday(expected)
  ...
  it('should return last working week day', () => {
    const expected = new Date(2017, 6, 30)
    const lastWeek = smorgasbord.Dates.lastWeek(expected)
  ...
  it('should return next working week day', () => {
    const expected = new Date(2017, 6, 30)
    const nextWeek = smorgasbord.Dates.nextWeek(expected)
